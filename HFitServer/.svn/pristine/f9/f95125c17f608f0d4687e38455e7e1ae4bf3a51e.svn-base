...
public class HomeTrainingVO implements Serializable{
	private int home_no;
	private String home_name;
	private String home_content;
	private String home_thumbnail;
	
	public HomeTrainingVO(int home_no, String home_name, String home_content, String home_thumbnail) {
		super();
