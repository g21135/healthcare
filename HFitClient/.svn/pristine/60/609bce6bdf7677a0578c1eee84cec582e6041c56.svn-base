...
public class CardInfoController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		/*card_Num1.setText("2579");
		card_Num2.setText("4538");
		card_Num3.setText("1462");
		card_Num4.setText("4232");
		cvc_Num.setText("213");
		card_Pass.setText("1345");
		cardAlidity_month.setText("5");
		cardAlidity_year.setText("21");
		mem_Bir1.setText("940215");
		mem_Bir2.setText("1188416");*/
		...
		if(card_Num1.getText().length() > 0) {
			card_Num2.requestFocus();
		}
...
//										try {
//										memPrice = cardService.getCardBalance(CardInfoController.cardName);
//										System.out.println(memPrice);
//									} catch (RemoteException e) {
//										e.printStackTrace();
//									}
