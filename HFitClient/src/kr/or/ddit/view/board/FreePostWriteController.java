...
public class FreePostWriteController implements Initializable {

	Parent parent;
	IPostService post;
	Registry reg;
	@FXML
	AnchorPane postWriteView;
	@FXML
	JFXTextField txtTitle;
	@FXML
	JFXTextArea txtContent;
	@FXML
	JFXButton okBtn;
	@FXML
	JFXButton cancleBtn;
...
//				FXMLLoader loader = new FXMLLoader(getClass().getResource("FreeMain.fxml"));
				FXMLLoader loader = new FXMLLoader(getClass().getResource("CommunityMain.fxml"));
				Parent parent = null;
				try {
					parent = loader.load();
				} catch (IOException e) {
...
//				((BorderPane) postWriteView.getParent()).setCenter(parent);
				 ...
				 * FXMLLoader(getClass().getResource("ReviewMain.fxml")); FXMLLoader loader =
				 * new FXMLLoader(getClass().getResource("ReviewMain.fxml")); FXMLLoader loader
				 * = new FXMLLoader(getClass().getResource("CommunityMain.fxml")); Parent parent
				 * = null; try { parent = loader.load(); } catch (IOException e) {
				 * e.printStackTrace(); }
				 * ((BorderPane)postWriteView.getParent()).setCenter(parent);
				 */
				((BorderPane) postWriteView.getParent()).setCenter(parent);
